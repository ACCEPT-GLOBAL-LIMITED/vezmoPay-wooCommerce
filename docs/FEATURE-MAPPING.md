...
| Connector / OAuth onboarding | `Connect` class holds the slot; onboarding is paste-keys only. | N/A — provider lacks it (contract doc: "OAuth / connect-style onboarding: NOT AVAILABLE"; keys are created in the Vezmo dashboard). |
